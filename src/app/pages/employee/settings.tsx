          ...
          {activeTab === 'notifications' && (
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <div>
                    <p className="text-sm text-gray-900">Leave Approval Alerts</p>
                    <p className="text-xs text-gray-600">Get notified when leave requests are processed</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-5 h-5 accent-[#C62828]" />
                </label>
                <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <div>
                    <p className="text-sm text-gray-900">Payroll Notifications</p>
                    <p className="text-xs text-gray-600">Receive notifications about payroll processing</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-5 h-5 accent-[#C62828]" />
                </label>
                <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <div>
                    <p className="text-sm text-gray-900">Announcement Alerts</p>
                    <p className="text-xs text-gray-600">Get notified about company announcements</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-5 h-5 accent-[#C62828]" />
                </label>
              </div>
