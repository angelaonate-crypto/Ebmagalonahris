          ...
          {activeTab === 'notifications' && (
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <div>
                    <p className="text-sm text-gray-900">New Applicant Alerts</p>
                    <p className="text-xs text-gray-600">Get notified of new job applications</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-5 h-5 accent-[#C62828]" />
                </label>
                <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <div>
                    <p className="text-sm text-gray-900">Payroll Reminders</p>
                    <p className="text-xs text-gray-600">Receive payroll processing reminders</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-5 h-5 accent-[#C62828]" />
                </label>
                <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Get notified about attendance issues</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-5 h-5 accent-[#C62828]" />
                </label>
              </div>
